...
const alertVariants = cva(
    "relative w-full rounded-xl border px-4 py-3 text-sm flex items-start gap-3 transition-all duration-200",
    {
        variants: {
            variant: {
                default: `
          bg-blue-500/10 text-blue-900 border-blue-400/40
          dark:bg-blue-500/10 dark:text-blue-200 dark:border-blue-400/20 backdrop-blur-sm
        `,
                warning: `
          bg-yellow-500/10 text-yellow-900 border-yellow-400/40
          dark:bg-yellow-500/10 dark:text-yellow-200 dark:border-yellow-400/20 backdrop-blur-sm
        `,
                error: `
          bg-red-500/10 text-red-900 border-red-400/40
          dark:bg-red-500/10 dark:text-red-200 dark:border-red-400/20 backdrop-blur-sm
        `,
                success: `
          bg-green-500/10 text-green-900 border-green-400/40
